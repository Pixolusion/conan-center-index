...
class OpenVDBConan(ConanFile):
    ...
    def requirements(self):
        # https://github.com/AcademySoftwareFoundation/openvdb/blob/v11.0.0/doc/dependencies.txt#L57-L84
        self.requires("boost/1.73.0", transitive_headers=True)
        self.requires("onetbb/2020.2", transitive_headers=True, transitive_libs=True)
